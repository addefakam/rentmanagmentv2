// generate_p6_docx.js — Phase 6 report assembler (3-section: cover / Roman TOC / Arabic body)
const {
...
const A = require("./p6_content_a");
const B = require("./p6_content_b");

const OUT = "/home/z/my-project/download/Rent_Control_System_Phase6_Report.docx";

const coverConfig = {
  title: "Phase 6 Report: User Acceptance and Legal Validation",
  subtitle: "Residential House Rent Control and Administration System - Gate G6 Package",
  englishLabel: "PHASE 6 DELIVERABLE",
  metaLines: [
    "Legal Basis: Proclamation 1320/2016 + Directive 7/2016 + Model Agreement",
    "Contents: UAT Scripts and Results, Legal Validation Memorandum, Defect Log",
    "Baseline: SRS v1.1 (CR-01 Trilingual: Amharic, English, Afan Oromo)",
    "Gate: G6 - Sign UAT Certificate and Authorize Migration and Pilot",
    "Date: September 2026",
  ],
  footerLeft: "Rent Control and Administration System Project",
  footerRight: "Phase 6 Report",
  ...
  return new Header({
    children: [new Paragraph({
      ...
      children: [new TextRun({
        text: "Rent Control and Administration System - Phase 6 Report: User Acceptance and Legal Validation",
...
const doc = new Document({
  ...
  title: "Residential House Rent Control and Administration System - Phase 6 Report",
  styles: {
    default: {
      document: {
