// generate_g9_docx.js — Gate G9 closure report assembler
// (3-section: cover / Roman TOC / Arabic body), mirroring the P8 pipeline.
const {
...
const A = require("./p9_content_a");
const B = require("./p9_content_b");

const OUT = "/home/z/my-project/download/Rent_Control_System_Gate_G9_Closure_Report.docx";

const coverConfig = {
  title: "Gate G9 Closure Report: Operations Under the Go-Live Order and Project Close",
  subtitle: "Residential House Rent Control and Administration System - Gate G9 Package",
  englishLabel: "GATE G9 CLOSURE DELIVERABLE",
  metaLines: [
    "Legal Basis: Proclamation 1320/2016 + Directive 7/2016 + Model Agreement",
    "Contents: Go-Live Order Execution, Hypercare, Annual Cycle, Enforcement, Ministry Feed, Handover, 90-Day PIR, Closure Minute",
    "Baseline: SRS v1.1 (CR-01 Trilingual: Amharic, English, Afan Oromo)",
    "Gate: G9 - Close the Project (Lessons Recorded; Closure Minute CM-P8-G9-01)",
    "Date: September 2026",
  ],
  footerLeft: "Rent Control and Administration System Project",
  footerRight: "Gate G9 Closure Report",
  ...
  return new Header({
    children: [new Paragraph({
      ...
      children: [new TextRun({
        text: "Rent Control and Administration System - Gate G9 Closure Report: Operations Under the Go-Live Order and Project Close",
...
const doc = new Document({
  ...
  title: "Residential House Rent Control and Administration System - Gate G9 Closure Report",
  styles: {
    default: {
      document: {
