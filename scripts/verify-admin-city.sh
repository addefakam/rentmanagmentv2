...
echo "$AD" | grep -q '"STF-0007"' && ok "AD roster still INCLUDES STF-0007 (ministry oversight)" || bad "AD roster lost STF-0007"
...
echo "$r" | grep -q "|200" && ok "STF-0007 via ADAMA -> 200 (analyst unchanged)" || bad "STF-0007 via AD -> $r"
